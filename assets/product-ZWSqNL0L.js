import{a as p,c as v,b as y,d as i,e as h,B as o,f as S,o as m,g as f,h as b}from"./selector-DV-y1yVU.js";import{g as u,a as x}from"./bortakvall-API-koG9ZvC9.js";p.addEventListener("click",()=>{window.location.href="/CandyStore"});v.addEventListener("click",()=>{window.location.href="/CandyStorecheckout-page.html"});y?.addEventListener("click",()=>{i?.classList.remove("invisible"),n()});h?.addEventListener("click",()=>{i?.classList.add("invisible")});let r=JSON.parse(localStorage.getItem("cart")||"[]");const c=()=>{let s=0;r.forEach(a=>{s+=a.cartQty}),document.querySelector(".cart-count").textContent=String(s)},d=s=>{const a=r.filter(t=>t.id!=s);r=a,localStorage.setItem("cart",JSON.stringify(a)),n()},n=async()=>{let s="",a=0;r.map(t=>{a+=t.price*t.cartQty,s+=`
